...
А нужна ли ? Буду помещать туда промежуточную выборку для удобства работы
/user/yarruss12/analytics/test


Директория будет предназначена для аналитиков
/user/yarruss12/analytics/project
По аналогии с данных, сохраненными в ходе урока